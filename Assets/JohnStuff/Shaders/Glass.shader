Shader "Custom/Glass"
{
    Properties
    {
        //we can modify these variables in the inspector
        _MainTex("Texture", 2D) = "white"{} //main texture
        _BumpMap("Normalmap",2D) = "bump"{} //bump map texture
         _ScaleUV ("Scale", Range(1,20)) = 1 //scale amount of the UV
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            //use HLSL, vertex, fragment functions and import shader code essentials and lighting
